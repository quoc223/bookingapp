...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const { data } = await axios.post(`${apiUrl}api/login/patient`, formData, {
                withCredentials: true // Ensure trailing slash is correct
            });

            // Success handling
            toast.success(data.message || 'Đăng nhập thành công');

            // Consider using replace instead of reload for better UX
        ...
        <div className="flex min-h-screen">
            ...
            <div className="w-full md:w-1/2 flex items-center justify-center p-8">
                <Card className="w-full max-w-[440px] p-8 shadow-none">
                    ...
                    <div className="mb-8">
                        <img
                            src={assets.logo||"/assets/logo.svg"}
                            alt="Filuick Pay"
                            className="h-10"
                        />
                    </div>
            ...
            <div className="hidden md:w-1/2 md:flex flex-col items-center justify-center bg-blue-500 p-8 text-white">
                <div className="max-w-lg text-center">
                    ...
                    <img
                        src={assets.DoctorAvatar||"/assets/doctor-avatar.svg"}
                        alt="Analytics Chart"
